...
gclib/lib/libgc.a: gclib/obj/gc_statics.o gclib/obj/gc_functions.o gclib/obj/gc_object.o gclib/obj/gc_internal_functions.o gclib/obj/gc_free_cell.o gclib/obj/gc_cell.o
	ar ru $@ $^
	ranlib $@
...
gclib/obj/gc_object.o: gclib/src/gc_object.cpp gclib/include/gc_object.h
	$(CC) $(CCFLAGS) -o $@ -c $<
gclib/obj/gc_internal_functions.o: gclib/src/gc_internal_functions.cpp gclib/include/gc_internal_functions.h
	$(CC) $(CCFLAGS) -o $@ -c $<
